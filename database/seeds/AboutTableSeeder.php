...
class AboutTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('about')->insert([
            'divider_text' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown.',
            'about_heading' => 'Contrary to popular',
