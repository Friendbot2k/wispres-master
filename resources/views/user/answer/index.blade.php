  ...
  'id' => "answer"
            ...
            <div class="answer-block">
                ...
                <div class="img-answer-block">
                    ...
                    {{--</label>--}}
                    <label for="images"><img src="{{url('images/inner-images/photo-icon.png')}}" alt="photo-icon"
                                             class="answer-icon">
                        <div class="loader">
                            <div class="loader-line"></div>
                        </div>
                ...
                <div class="video-answer-block">
                    ...
                    <label for="videos"><img src="{{ url('images/inner-images/video-icon.png') }}" alt="video-icon"
